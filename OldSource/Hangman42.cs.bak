...
// BEGIN CUT HERE
	...
	private void test_case_0() { string[] Arg0 = new string[]{"top","web","cam","buy","now"}; double Arg1 = 0.6; verify_case(0, Arg1, probability(Arg0)); }
	private void test_case_1() { string[] Arg0 = new string[]{"a"}; double Arg1 = 1.0; verify_case(1, Arg1, probability(Arg0)); }
	private void test_case_2() { string[] Arg0 = new string[]{"ozeexsuaihtuucqghqsjzqzugmaebvdrddyztehr",
...
"yidryvjmpbjkdzhmhtoynhbwlbsehcbymltrddsj"}; double Arg1 = 0.8888888888888888; verify_case(2, Arg1, probability(Arg0)); }

// END CUT HERE
// BEGIN CUT HERE
public static void Main() {
try {
Hangman42 ___test = new Hangman42();
___test.run_test(-1);
} catch(Exception e) {
